...
# =====================================================================
#  Convergence on various tasks
# =====================================================================


class TestConvergence:
    """LUMA must converge on small well-posed problems."""

    def test_rosenbrock(self, device):
    ...
    def test_mlp_classification(self, device):
    ...
    def test_mlp_regression(self, device):
